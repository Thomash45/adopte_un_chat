 ...
 */
final class Version20180717205827 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE announce ADD gender_id INT NOT NULL, ADD lat DOUBLE PRECISION DEFAULT NULL, ADD logt DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE announce DROP gender_id, DROP lat, DROP logt');
    }
}
