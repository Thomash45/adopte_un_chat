 ...
 */
final class Version20180717211620 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE announce DROP usera_id, DROP gender_id, DROP street_number, DROP road, DROP country, DROP lat, DROP logt, DROP is_granted');
    }
}
