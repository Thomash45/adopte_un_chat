 ...
 */
final class Version20180717212154 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE announce (id INT AUTO_INCREMENT NOT NULL, race_id INT NOT NULL, coat_color_id INT NOT NULL, coat_style_color_id INT NOT NULL, coat_id INT NOT NULL, usera_id INT NOT NULL, gender_id INT NOT NULL, name VARCHAR(255) NOT NULL, year INT DEFAULT NULL, description LONGTEXT NOT NULL, adresse VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, code_postal VARCHAR(255) NOT NULL, departement VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, telephone_number VARCHAR(255) NOT NULL, image_name VARCHAR(255) NOT NULL, image_size INT NOT NULL, updated_at DATETIME NOT NULL, street_number VARCHAR(255) DEFAULT NULL, road VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, lat DOUBLE PRECISION DEFAULT NULL, logt DOUBLE PRECISION DEFAULT NULL, is_granted TINYINT(1) NOT NULL, INDEX IDX_E6D6DD756E59D40D (race_id), INDEX IDX_E6D6DD753A60210A (coat_color_id), INDEX IDX_E6D6DD75ACD043E7 (coat_style_color_id), INDEX IDX_E6D6DD7579F419D (coat_id), INDEX IDX_E6D6DD759DA32B29 (usera_id), INDEX IDX_E6D6DD75708A0E0 (gender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
